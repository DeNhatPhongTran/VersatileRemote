...
**VersatileRemote** là hệ thống điều khiển từ xa vạn năng chạy trên board mạch **STM32F429I_DISCO** kết hợp giao diện đồ họa **TouchGFX**. Hệ thống hỗ trợ tính năng học lệnh (Learn) tín hiệu hồng ngoại (IR) từ các remote thực tế và phát lại (Playback) để điều khiển thiết bị thật (như TV, Điều hòa/AC).

---

## 1. Chức năng chính

* **Thu nhận & Giải mã Tín hiệu Hồng ngoại (IR Capture & Decoding):**
...
* **Phát lại Tín hiệu Hồng ngoại (IR Transmission):**
...
* **Quản lý thiết bị lưu trữ dạng tĩnh (Static Registry):**
...
## 2. Cấu hình chân ngoại vi (Peripheral Pin Configuration)

Các linh kiện ngoại vi được kết nối vào các chân GPIO của mạch STM32F429I_DISCO theo cấu hình dưới đây:
...
## 3. Quy trình học và phát lệnh (Learning & Playback Process)
...
## 4. Đóng góp dự án (Contributions)

Dự án được xây dựng và đóng góp bởi các thành viên:

* **Trịnh Tuấn Phong và Lê Đức Phương:** Triển khai giao diện người dùng (UI/UX) và thiết kế giao diện trên TouchGFX.
* **Trương Minh Phương và Trần Đức Thu:** Triển khai logic thu nhận, giải mã và phát lại tín hiệu hồng ngoại (IR driver).
* **Vũ Minh Ánh:** Triển khai và tích hợp tính năng trigger mô-tơ rung phản hồi khi học tín hiệu thành công.